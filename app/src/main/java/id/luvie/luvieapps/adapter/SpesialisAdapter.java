...
import id.luvie.luvieapps.model.listDokter.DataItem;
...
public class SpesialisAdapter extends RecyclerView.Adapter<SpesialisAdapter.SpesialisViewHolder> {
    ...
    public SpesialisAdapter(Context context, List<DataItem> dataDokter) {
    ...
    @NotNull
    @Override
    public SpesialisViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull SpesialisViewHolder holder, int position) {
    ...
    public class SpesialisViewHolder extends RecyclerView.ViewHolder {
        ...
        public SpesialisViewHolder(@NonNull @NotNull View itemView) {
            super(itemView);
