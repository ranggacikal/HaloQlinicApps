...
public class JadwalKonsultasiAdapter extends RecyclerView.Adapter<JadwalKonsultasiAdapter.JadwalKonsultasiViewHolder> {
    ...
    public void onBindViewHolder(@NonNull @NotNull JadwalKonsultasiViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        final String url_image = "https://luvie.co.id/file/dokter/profile/"+image;
        ...
        PushDownAnim.setPushDownAnimTo(holder.itemView)
                ...
                .setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String status_konsultasi = dataKonsultasi.get(position).getStatusKonsultasi();
                        ...
                        if (mulai_konsultasi.equals("") && batas_konsultasi.equals("")){
                            ...
                            intentChat.putExtra("status_konsultasi", status_konsultasi);
                            intentChat.putExtra("from_activity", "jadwal_konsultasi");
