...
import id.luvie.luvieapps.adapter.SliderAdapter;
import id.luvie.luvieapps.api.ConfigRetrofit;

import id.luvie.luvieapps.databinding.ActivityDetailArtikelBinding;
import id.luvie.luvieapps.model.detailArtikel.DataItem;
import id.luvie.luvieapps.model.detailArtikel.ListItem;
        ...
        ConfigRetrofit.service.detailArtikel(id_artikel).enqueue(new Callback<ResponseDetailArtikel>() {
            ...
            public void onResponse(Call<ResponseDetailArtikel> call, Response<ResponseDetailArtikel> response) {
                if (response.isSuccessful()) {
                    ...
                    String link = "https://luvie.co.id/img/artikel/";
