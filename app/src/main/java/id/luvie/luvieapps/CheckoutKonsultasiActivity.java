...
import id.luvie.luvieapps.adapter.KategoriBayarKonsultasiAdapter;
...
public class CheckoutKonsultasiActivity extends AppCompatActivity {
    ...
    public String id_dokter, jadwal_dokter, nomerTelepon, id_transaksi, status, token_dokter, nama_dokter, player_id_dokter;
    ...
    public String image_dokter, spesialis_dokter;

    public String external_id, buat_jadwal;
    private SharedPreferencedConfig preferencedConfig;

    public CheckoutKonsultasiActivity(){

    }

    public static CheckoutKonsultasiActivity cka;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("biayaKonsultasi", "onCreate: "+biaya);
        ...
        ConfigRetrofit.service.qrisKonsultasi(id_transaksi, id_customer, total, biayaAdminPost, id_dokter, kategori,
            ...
            public void onResponse(Call<ResponseQrisKonsultasi> call, Response<ResponseQrisKonsultasi> response) {
                if (response.isSuccessful()){
                    ...
                    Log.d("id_transaksi_checkout", "onResponse: "+id_transaksi_intent);
                    ...
                    intent.putExtra("id_transaksi_intent", id_transaksi_intent);
        ...
        ConfigRetrofit.service.ewalletKonsultasi(id_transaksi, id_customer, total, kode, "0", biayaAdminPost,
            ...
            public void onResponse(Call<ResponseEwalletKonsultasi> call, Response<ResponseEwalletKonsultasi> response) {
                if (response.isSuccessful()){
                    ...
                    String id_transaksi_intent = "";

                    id_transaksi_intent = response.body().getMetadata().getIdTransaksi();
        ...
        ConfigRetrofit.service.kategoriXendit().enqueue(new Callback<ResponseKategoriXendit>() {
            ...
            public void onResponse(Call<ResponseKategoriXendit> call, Response<ResponseKategoriXendit> response) {
                if (response.isSuccessful()){
                    ...
                    List<id.luvie.luvieapps.model.kategoriXendit.DataItem> dataKategori = response.body().getData();
                    KategoriBayarKonsultasiAdapter kategoriBayarAdapter = new KategoriBayarKonsultasiAdapter(CheckoutKonsultasiActivity.this,
                            dataKategori, CheckoutKonsultasiActivity.this);
            ...
            public void onResponse(Call<ResponseJadwalDokter> call, Response<ResponseJadwalDokter> response) {
                if (response.isSuccessful()){
                    ...
                    for (int i = 0; i<dataDokter.size(); i++){
                        ...
                        image_dokter = dataDokter.get(i).getImg();
