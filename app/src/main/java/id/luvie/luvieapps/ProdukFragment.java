...
import id.luvie.luvieapps.adapter.CariProdukAdapter;
import id.luvie.luvieapps.adapter.ProdukAdapter;
import id.luvie.luvieapps.api.ConfigRetrofit;
import id.luvie.luvieapps.model.cariProduk.ResponseCariProduk;
import id.luvie.luvieapps.model.produk.DataItem;
        ...
        ConfigRetrofit.service.cariProduk(newText).enqueue(new Callback<ResponseCariProduk>() {
            ...
            public void onResponse(Call<ResponseCariProduk> call, Response<ResponseCariProduk> response) {
                if (response.isSuccessful()) {
                    ...
                    List<id.luvie.luvieapps.model.cariProduk.DataItem> dataItems = response.body().getData();
