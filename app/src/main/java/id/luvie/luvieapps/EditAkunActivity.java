...
import id.luvie.luvieapps.model.kota.ResponseItem;
import id.luvie.luvieapps.model.provinsi.DataItem;
...
public class EditAkunActivity extends AppCompatActivity {
    ...
    List<id.luvie.luvieapps.model.kecamatan.ResponseItem> dataKecamatan;
        ...
        ConfigRetrofit.service.editAkun(id_customer, nama, alamat, no_hp, jenisKelaminPost, provinsiPost, kotaPost, kecamatanPost,
            ...
            public void onResponse(Call<ResponseEditAkun> call, Response<ResponseEditAkun> response) {
                if (response.isSuccessful()){
                    ...
                    List<id.luvie.luvieapps.model.editAkun.ResponseItem> dataEditAkun = response.body().getResponse();
