...
public class DokterUmumAdapter extends RecyclerView.Adapter<DokterUmumAdapter.DokterUmumViewHolder> {
    ...
    Context context;
    List<com.haloqlinic.haloqlinicapps.model.listDokterumum.DataItem> dokterList;

    public DokterUmumAdapter(Context context, List<com.haloqlinic.haloqlinicapps.model.listDokterumum.DataItem> dokterList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull DokterUmumViewHolder holder, int position) {
