...
public class OnlineDrTersediaAdapter extends RecyclerView.Adapter<OnlineDrTersediaAdapter.OnlineTersediaViewHolder> {
    ...
    Context context;
    List<DataItem> dataDokterTersedia;

    public OnlineDrTersediaAdapter(Context context, List<DataItem> dataDokterTersedia) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull OnlineTersediaViewHolder holder, int position) {
