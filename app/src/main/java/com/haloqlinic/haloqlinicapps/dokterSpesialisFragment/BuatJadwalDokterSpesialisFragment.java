package com.haloqlinic.haloqlinicapps.dokterSpesialisFragment;
...
import com.haloqlinic.haloqlinicapps.adapter.BuatJadwalSpesialisAdapter;
import com.haloqlinic.haloqlinicapps.adapter.CariJadwalSpesialisAdapter;
import com.haloqlinic.haloqlinicapps.adapter.OnDokterSpesialisAdapter;
import com.haloqlinic.haloqlinicapps.api.ConfigRetrofit;
import com.haloqlinic.haloqlinicapps.model.cariDokter.ResponseCariDokter;
import com.haloqlinic.haloqlinicapps.model.dokterSpesialis.DataItem;
        ...
        ConfigRetrofit.service.cariDokter(newText, "2", "spesialis").enqueue(new Callback<ResponseCariDokter>() {
            ...
            public void onResponse(Call<ResponseCariDokter> call, Response<ResponseCariDokter> response) {
                if (response.isSuccessful()){
                    ...
                    List<com.haloqlinic.haloqlinicapps.model.cariDokter.DataItem> datCari = response.body().getData();
