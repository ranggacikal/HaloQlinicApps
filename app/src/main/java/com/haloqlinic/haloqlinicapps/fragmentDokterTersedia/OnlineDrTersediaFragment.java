...
public class OnlineDrTersediaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_online_dr_tersedia, container, false);

        rvDokterTersedia = rootView.findViewById(R.id.rv_dokter_spesialis_online);
        progressBar = rootView.findViewById(R.id.progressBarOnlineTersedia);
        searchDokter = rootView.findViewById(R.id.cari_dokter_tersedia_online);
...
//                super.onScrolled(recyclerView, dx, dy);
    ...
    private void getDokterOnline() {
        ...
        ConfigRetrofit.service.dokterTersedia("list", "1", String.valueOf(page))
